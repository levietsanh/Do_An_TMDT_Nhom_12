...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-VKVMARM\\SQLEXPRESS01;Database=ShoppingCartDB;Trusted_Connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerOrder>(entity =>
            {
                ...
                entity.Property(e => e.PaymentReferenceNumber).HasMaxLength(50);
            ...
            modelBuilder.Entity<FoodOrder>(entity =>
            {
                ...
                entity.Property(e => e.DesertName).HasMaxLength(200);

                entity.Property(e => e.DishType).HasMaxLength(200);

                entity.Property(e => e.Dqty)
                    .HasMaxLength(10)
                    .HasColumnName("DQty");

                entity.Property(e => e.MainName).HasMaxLength(200);
                ...
                entity.Property(e => e.StarterName).HasMaxLength(200);
            });
