...
namespace Shop.Web.Services
{
    public class UserPanelService : IUserPanelService
    {
        ...
        {
            return await httpClient.PostJsonAsync<ProductModel>("api/user/SaveProduct", newProduct);
        }
        ...
        {
            return await httpClient.PostJsonAsync<CategoryModel>("api/user/SaveCategory", newCategory);
        }
